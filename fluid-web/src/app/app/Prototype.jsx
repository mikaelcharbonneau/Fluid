        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap', minWidth: 0, flex: '1 1 auto' }}>
            <button type="button" onClick={() => setModesOpen((v) => !v)} className="home-chip" aria-expanded={modesOpen} style={{
              ...
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="9" /><path d="M12 3a9 9 0 0 0 0 18z" fill="currentColor" stroke="none" /></svg>
              Look &amp; feel
            </button>
        ...
        <div className="home-grid-3" style={{ display: 'grid', gap: 18 }}>
          {recent.slice(0, 3).map((b) => {
            ...
            <div key={b.id} className="b-card"
              ...
              style={{ borderRadius: 18, overflow: 'hidden', cursor: 'pointer', background: '#fff', boxShadow: '0 1px 2px rgba(0,0,0,.06), inset 0 0 0 1px rgba(0,0,0,.10)' }}>

              <div className={'b-thumb' + (hasBoard ? ' b-thumb--plain' : '')} style={{ position: 'relative', height: 120 }}>
              ...
              <div style={{ padding: '16px 18px 18px', display: 'flex', flexDirection: 'column', gap: 12 }}>
                {hasBoard && (
                <div style={{ fontFamily: 'var(--font-display)', fontSize: 17, fontWeight: 700, letterSpacing: '-0.025em', color: '#000', lineHeight: 1.1, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                  {brandDisplayName(b)}
                </div>
                )}
                <div style={{ fontSize: 13, color: 'rgba(0,0,0,.52)', lineHeight: 1.45, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                  {brief || ' '}
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  {prog.pct !== null && (
